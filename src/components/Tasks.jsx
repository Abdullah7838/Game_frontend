...
const handleAdds=()=>{
  ...
  const { add, balance,login, setBalance } = useContext(AppContext);
const balanceManager=()=>{
  ...
  return (
    ...
    <div className='flex justify-center flex-col items-center'>
      ...
      <div className='text-md font-bold mt-2 text-blue-700'>Your Balance is: {balance} rupees</div>
      ...
      <div className='flex justify-between items-center w-full max-w-md p-2 bg-gray-100 rounded-lg shadow'>
        <div className='mr-4 ml-2 font-bold text-lg'>Share with 2 friends & get 50 rupees</div>
      ...
      <div className='flex justify-between items-center w-full max-w-md p-2 bg-gray-100 rounded-lg shadow'>
        <div className='mr-4 ml-2 font-bold text-lg'>Share to your WhatsApp Status & get 50 rupees</div>
        {!isHiddenShareStatus && (
          <button 
