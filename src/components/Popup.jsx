...
function Popup() {
    ...
    return (
        <div className="fixed top-40 left-1/2 transform -translate-x-1/2 z-50 bg-zinc-900 w-72 h-56 rounded-lg flex flex-col items-center justify-center shadow-lg transition-transform duration-300 ease-in-out">
            <div className="font-bold text-center text-white text-xl mb-2">Announcement</div>
            <div className="text-center text-blue-400 p-2">
                Withdraws are opening on 31 October.
